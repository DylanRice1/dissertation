...
VGG_model = tf.keras.Sequential([tf.keras.Input(shape=(None, None, 3), name="input_layer"),
                                      data_augmentation,
...
model_history = VGG_model.fit( train_data,
                    epochs = EPOCH,
...
test_loss, test_accuracy = VGG_model.evaluate(test_data, verbose = 0)
